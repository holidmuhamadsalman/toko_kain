...
<body class="sub_page">
  ...
  $query = mysqli_query($conn, "SELECT nama, harga, gambar FROM produk");
  ?>
  <section class="brand_section">
    <div class="container">
      ...
      <div class="brand_container layout_padding2">
        ...
        <img src="images/<?php echo $row['gambar'];?>" class="card-img-top"/>
          <div class="card-body detail-box">
            <h6 class="card-title"><?php echo $row['nama'];?></h6>
            <h6 class="card-text price"><?php echo $row['harga'];?></h6>
          </div>
        </div>
        <?php endforeach; ?>
      </div>
