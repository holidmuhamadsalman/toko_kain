        ...
        <nav class="navbar navbar-expand-lg custom_nav-container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="../produk/produk.php">Produk</a>
              </li>
            </ul>
                ...
                <table id="MyTable" class="display">
                        ...
                        <tbody>
                                ...
                                <tr>
                                        ...
                                        <td>
                                            <a href="edit.php?id_kategori=<?php echo $data['id_kategori']?>" class="btn btn-primary"><i class="fa fa-pencil-square-o"></i></a>
                                            <a href="hapus.php?id_kategori=<?php echo $data['id_kategori']?>" onclick="return confirm('Yakin Hapus?')" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                </tr>
                                <?php $no++; } ?>
                                <?php } ?>
