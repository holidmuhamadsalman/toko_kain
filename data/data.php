...
<div class="container mt-3">
        <h1 class="mb-3 font-weight-bold"><u>Data Suplier</u></h1>
                <form action="" method="post">
                <table id="TableSuplier" class="display">
...
?>
<div class="container mt-3">
    <h1 class="mb-3 font-weight-bold"><u>Data Kategori</u></h1>
        <form action="" method="post">
          <table id="TableKategori" class="display">
            <thead style="background-color: lightgreen;">
                <tr>
                    <th>No</th>
                    <th>Id Kategori</th>
...
?>
<div class="container mt-3">
    <h1 class="mb-3 font-weight-bold"><u>Data Produk</u></h1>
        <form action="" method="post">
