...
<body class="sub_page">
  ...
  <!-- Data Suplier section -->
  <?php
  include "../config.php";
  $query = mysqli_query($conn, "SELECT * FROM suplier");
  ?>
  <div class="container mt-3">
        <h1 class="mb-3">Data Suplier</h1>
                ...
                <table id="MyTable" class="display">
                        ...
                        <tbody>
                                ...
                                <tr>
                                        ...
                                        <td>
                                            <a href="edit.php?id_suplier=<?php echo $data['id_suplier']?>" class="btn btn-primary"><i class="fa fa-pencil-square-o"></i></a>
                                            <a href="hapus.php?id_suplier=<?php echo $data['id_suplier']?>" onclick="return confirm('Yakin Hapus data?')" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                </tr>
                                <?php $no++; } ?>
                                <?php } ?>
